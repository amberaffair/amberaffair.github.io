...
;(function (d) {
    d.flexslider = function (i, k) {
        var a = d(i), c = d.extend({}, d.flexslider.defaults, k),
            e = c.namespace,
            p = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch,
            t = p ? "touchend" : "click", l = "vertical" === c.direction,
            m = c.reverse, h = 0 < c.itemWidth, r = "fade" === c.animation,
            s = "" !== c.asNavFor, f = {};
...
(function (C, z, f, r) {
    var q = f(C), n = f(z), b = f.fancybox = function () {
        ...
        }, H = navigator.userAgent.match(/msie/), w = null, s = z.createTouch !== r,
        t = function (a) {
    ...
    f.extend(b, {
        ...
        _preloadImages: function () {
            var a =
                    b.group, d = b.current, e = a.length,
        ...
        _setDimension: function () {
            var a = b.getViewport(), d = 0, e = !1, c = !1, e = b.wrap,
                k = b.skin, g = b.inner, h = b.current, c = h.width,
                j = h.height, m = h.minWidth, u = h.minHeight, n = h.maxWidth,
                v = h.maxHeight, s = h.scrolling,
                q = h.scrollOutside ? h.scrollbarWidth : 0, y = h.margin,
                p = l(y[1] + y[3]), r = l(y[0] + y[2]), z, A, t, D, B, G, C, E,
                w;
        ...
        _getPosition: function (a) {
            var d = b.current, e = b.getViewport(), c = d.margin,
    ...
    b.transitions = {
        getOrigPosition: function () {
            var a = b.current, d = a.element, e = a.orig, c = {}, f = 50,
                g = 50, h = a.hPadding, j = a.wPadding, m = b.getViewport();
            ...
            var a = b.current, d = a.pos, e = a.openEffect, c = "elastic" === e,
            ...
            var a = b.current, d = a.closeEffect, e = "elastic" === d,
                c = {opacity: 0.1};
            ...
            var a =
                    b.previous, d = a.prevEffect, e = {opacity: 0.1},
                c = b.direction;
...
(function (b) {
    ...
    function a(d, k, p) {
        ...
        var n = c.offset().top + c.width() / 2 - i.offset().top,
            o = c.offset().left + c.height() / 2 - i.offset().left,
            h = Math.floor(Math.sqrt(Math.pow(o, 2) + Math.pow(n, 2))),
            e = (h / p.pixels_per_second) * 1000,
            l = b("<div>" + g + "</div>").css(p.initial_css).appendTo("body").animate({
                top: i.offset().top,
                left: i.offset().left,
                height: m,
                width: j
